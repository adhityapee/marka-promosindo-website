...
const WA_HREF = "https://wa.me/6281399768866?text=Halo%2C+saya+ingin+bertanya+tentang+produk+Marka+Promosindo"
  ...
  return (
    <>
      <nav className="navbar">
        ...
        <a href={WA_HREF} target="_blank" rel="noopener noreferrer" className="nav-wa nav-wa-desktop">
          {WA_ICON}
          WhatsApp
        </a>
      ...
      <div className={`mobile-drawer${open ? ' open' : ''}`}>
        <nav className="mobile-nav">
          <Link to="/" activeProps={{ className: 'active' }} onClick={close}>Beranda</Link>
          <Link to="/products" activeProps={{ className: 'active' }} onClick={close}>Produk</Link>
          <Link to="/about" activeProps={{ className: 'active' }} onClick={close}>Tentang Kami</Link>
          <Link to="/contact" activeProps={{ className: 'active' }} onClick={close}>Kontak</Link>
        </nav>
        <a href={WA_HREF} target="_blank" rel="noopener noreferrer" className="nav-wa mobile-wa" onClick={close}>
          {WA_ICON}
