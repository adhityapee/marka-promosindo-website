    ...
    <div style={{ paddingTop: 'var(--header-h)' }}>
      <div className="contact-section">
        <div className="contact-left">
          <div className="sec-label">Hubungi Kami</div>
          <h2 className="sec-title">Siap Membantu<br />Kebutuhan Anda</h2>
          <p className="sec-desc" style={{ marginBottom: '40px' }}>
          ...
          <div className="contact-items">
            ...
            >
              <div className="contact-icon">
                <svg viewBox="0 0 24 24" fill="currentColor" style={{ color: 'white' }}>
        ...
        <div className="contact-right">
          <h3>Kirim Pesan</h3>
          {status === 'success' ? (
            <div style={{ color: 'var(--gray)', fontSize: '15px', lineHeight: 1.8 }}>
