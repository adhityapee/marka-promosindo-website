...
function Navbar() {
  return (
    <nav className="navbar">
      ...
      <a href="https://wa.me/6281399768666?text=Halo%2C+saya+ingin+bertanya+tentang+produk+Marka+Promosindo" target="_blank" rel="noopener noreferrer" className="nav-wa">
